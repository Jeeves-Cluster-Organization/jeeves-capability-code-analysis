...
This is a standalone application built on jeeves_mission_system.
It implements a 7-agent pipeline for read-only code analysis.

Architecture:
    jeeves-capability-code-analyser (this app)
        ↓ imports
    jeeves_mission_system (generic orchestration + contracts)
        ↓ imports
    jeeves_avionics (infrastructure adapters)
        ↓ imports
